...
DROP INDEX IF EXISTS index_contributions_on_author_id_and_title_id CASCADE;
DROP INDEX IF EXISTS index_contributions_on_author_id CASCADE;
DROP INDEX IF EXISTS index_contributions_on_title_id CASCADE;
